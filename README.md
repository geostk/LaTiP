...
<img alt="" src="https://github.com/jingge326/MaterialFolder/blob/master/plot_points.png" style=" max-height:500px; min-height:10px; max-width:500px; min-width:100px">
