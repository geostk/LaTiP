...
# require(Cairo)
# Cairo(width = 8, height = 5, file="E:/Research/Land Cover Mapping/Paper/material/six_cures_deciduous.png",
...
p+geom_point(mapping = aes(shape = variable), size = 2, na.rm = TRUE)+
